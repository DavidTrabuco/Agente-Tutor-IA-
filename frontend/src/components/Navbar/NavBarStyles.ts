export const NavBarStyles = {
 ...
 navButton: "flex items-center gap-2 ml-10 px-4 py-2 rounded-lg border border-[#3a3a3a] text-[#d1d5db] text-sm hover:bg-[#2a2a2a] transition-colors cursor-pointer bg-transparent",
